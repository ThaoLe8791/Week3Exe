...
// CODE HERE
each(names,(item,ind) => {
  console.log(`The item at index ${ind} is ${item}.`)
})
...
// CODE HERE 
const getUserById = (arr, idx, callback) => {
  const userObj = arr.filter((user) => user.id === idx);
  callback(userObj[0]);
}
...
// CODE HERE
const addNumber27 = addingfactory(27);
console.log(addNumber27(20));